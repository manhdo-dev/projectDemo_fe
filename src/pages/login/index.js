...
export default function Login({ register, forgot}) {
  ...
  const { run: runGG } = useRequest((token) => ({
  ...
  const handleLoginFb = (e) => {
    ...
    FB.login(async function(response) {
      ...
      const data = await run(response.authResponse.accessToken);
          ...
          >
            ...
            <div className={styles.bottom}>
                ...
                <div className={styles.icon}>
                  ...
                  <GoogleLogin
                      clientId="168287242909-kcsqvqa2uku89nddsahkqivnvo9ksohh.apps.googleusercontent.com"
                      render={renderProps => (
                  ...
                  <div>
                    <a href="#" onClick={(e) => {handleLoginFb(e)}}>
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
